        ...
        pricing: {
          radio: {
            pb_warranty1: [
              {
                radio: 'pb_warranty',
                description: 'One Year Warranty ($0)',
                type: 'warranty',
                selected: false,
                value: 0
              }
            ...
            pb_warranty2: [
              {
                radio: 'pb_warranty',
                description: 'Two Years Warranty ($40)',
                type: 'warranty',
                selected: true,
                value: 40
              }
            ...
            pb_warranty3: [
              {
                radio: 'pb_warranty',
                description: 'Lifetime Warranty ($200)',
                type: 'warranty',
                selected: false,
                value: 200
              }
          ...
          select: {
            ...
            pb_straps_mat: [
              ...
              {
                title: 'Straps Material',
                name: 'Adamantium Cloth ($10)',
                description: 'Adamantium Cloth',
                type: 'outer',
                selected: true,
                value: 10
              }
          ...
          checkbox: {
            ...
            pb_additional_aspadding: [
              {
                title: 'Additionals',
                description: 'Anti Sweat Padding',
                type: 'inner',
                selected: true,
                value: 8
              }
            ],
            pb_additional_lcloth: [
              {
                title: 'Additionals',
                description: 'Light Cloth',
                type: 'inner',
                selected: true,
                value: 2
              }
            ],
            pb_additional_ashockpro: [
              {
                title: 'Additionals',
                description: 'Antishock Pro',
                type: 'inner',
                selected: false,
                value: 12
              }
